 ...
 */
module.exports = function(temperature, pressure, dewPoint, units = constants.METRIC) {
    ...
    const ap = units === constants.IMPERIAL ? convertPressureToMetric(pressure) : pressure;
